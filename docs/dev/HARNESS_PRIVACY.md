...
- `src/mordred_hermes/llm_guard/harness_detect.py` (the existing harness-refusal mechanism — **config-declared**, see §4)
- `src/mordred_hermes/keyvault/log_encryption.py` / `crypto.py` (Mordred's own at-rest encryption)
