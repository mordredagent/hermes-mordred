"""mordred_hermes.wizard._term — minimal, dependency-free terminal styling.

The wizard CLI is plain ``print()`` with no colour. This module centralises the
...
Design contract (mirrors :mod:`mordred_hermes.wizard._runtime` as the shared
helper home):
